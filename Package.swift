...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "RaTeXFFI",
            url: "https://github.com/erweixin/RaTeX/releases/download/v0.0.16/RaTeX.xcframework.zip",
            checksum: "114629dd6aa5eeb6356acca77164a018fe9a95b82d87663102baafd9e6d71ee5"
        ),
