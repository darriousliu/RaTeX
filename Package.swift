...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "RaTeXFFI",
            url: "https://github.com/erweixin/RaTeX/releases/download/v0.1.1/RaTeX.xcframework.zip",
            checksum: "05a81f6f0ec246e9c284f7f9f52ec63b55ab3878047cb459420c7d046f422362"
        ),
