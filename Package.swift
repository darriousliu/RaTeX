...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "RaTeXFFI",
            url: "https://github.com/erweixin/RaTeX/releases/download/v0.0.14/RaTeX.xcframework.zip",
            checksum: "80a1bc88e417c16f3f4a2c6ff9bbea7e26f7df04d09a2b7905d199dafdb6b0ba"
        ),
