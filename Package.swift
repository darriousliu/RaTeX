...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "RaTeXFFI",
            url: "https://github.com/erweixin/RaTeX/releases/download/v0.1.2/RaTeX.xcframework.zip",
            checksum: "a698e287e49dd973c03298974b4bf31ce98c314a97cdf6d5f8eeb9801e4ba48f"
        ),
